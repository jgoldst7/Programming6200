package Assignment6::Config 1.01;
use strict;
use warnings;
use Carp qw( confess );
use Exporter 'import';
...
#getUnigeneDirectory
Readonly our $UNIGENE_DIR => '/data/PROGRAMMING/assignment6'; 
...
Assignment6::Config - package to create a config file
...
=head1 DESCRIPTION	
 ...
 This module was designed for use by the Assignment 6 programs, 
...
PERL5LIB=/Users/jeremysports7/Fall_2018/programming6200/assignment6
export PERL5LIB

then must use 

use lib '/Users/jeremysports7/Fall_2018/programming6200/assignment6';
